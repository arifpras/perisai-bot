...
async def examples_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    examples_text = (
        "📝 <b>Query Examples:</b>\n\n"
        "<b>Point queries (specific date):</b>\n"
        "• <code>yield 10 year 2025-06-15</code>\n"
        "• <code>yield 5 year june 2025</code>\n"
        "• <code>FR103 price 5 year June 15 2025</code>\n"
        "• <code>FR95 yield 2024-03-20</code>\n\n"
        "<b>Range queries (with statistics):</b>\n"
        "• <code>average yield 10 year June 2025</code>\n"
        "• <code>max yield FR103 2024</code>\n"
        "• <code>compare yield 10 year 2024 and 2025</code>\n\n"
        "<b>Plot queries (with charts):</b>\n"
        "• <code>plot yield 10 year 2025</code>\n"
        "• <code>chart FR103 5 year June 2025</code>\n"
        "• <code>show price 5 year 2024 and 2025</code>\n\n"
        "<b>Multi-tenor plots (side-by-side):</b>\n"
        "• <code>plot 5 year and 10 year 2025</code>\n"
        "• <code>chart yield 5 year and 10 year June 2025</code>\n"
        "• <code>show price FR95 and FR104 2024</code>\n\n"
        "<b>Auction forecasts:</b>\n"
        "• <code>/kei auction demand January 2026</code>\n"
        "• <code>/kei incoming bids February 2026</code>\n"
        "• <code>/kei awarded amount Q1 2026</code>\n"
        "• <code>/both bid to cover 2026</code>\n\n"
        "💡 Tip: Use 'plot' or 'chart' to get visual graphs!\n"
        "💬 Request custom formats: <code>/kei plot yield 5 year in bullet points</code>\n\n"
        "🤖 <b>Personas:</b>\n\n"
        ...
        "🔄 <b>/both</b> — Chain analysis (Kei → Kin)\n"
        "• Kei analyzes quantitatively, then Kin interprets strategically\n"
        "• Single output with 🎯 emoji branding\n"
        "• Signature: <code>Kei & Kin | Data → Insight</code>\n\n"
        ...
        "• Use <b>/both</b> for comprehensive analysis combining quantitative data + strategic interpretation\n\n"
        "📊 <b>Data Coverage:</b>\n"
        "• Bond prices/yields: 2023-2025 (FR95-FR104, 5Y/10Y tenors)\n"
        "• Auction forecasts: Dec 2025 - Dec 2026 (demand, awarded, bid-to-cover)\n"
        "• Use keywords: 'auction', 'demand', 'incoming', 'awarded', 'bid to cover' for forecast queries"
    )
