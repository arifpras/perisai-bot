...
async def ask_kei(question: str, dual_mode: bool = False) -> str:
    ...
    if is_data_query:
        system_prompt = (
            ...
            "  - Key readings: Sovereign Debt (17-18), Bond Pricing & Yields (21-27), Duration & Convexity (38-50), Credit Risk (53-59)\n"
            "  - Apply duration/convexity framework for interest rate sensitivity analysis\n"
            "  - Use yield curve interpretation and forward rate analysis for Indonesian bonds\n"
            "- **CFA Economics Module** (33 lessons): Monetary policy, fiscal policy, FX markets, business cycles\n"
            "  - Reference BI rate policy, IDR/USD dynamics, inflation targets, fiscal constraints\n"
            "- **CFA Quantitative Methods** (47 lessons): Time value of money, statistical analysis, regression\n"
            "  - Statistical hypothesis testing for trend significance\n"
            "  - Annualized returns and volatility calculations\n"
            "- **CFA Portfolio Management** (64 lessons): Asset allocation, CAPM, duration matching\n"
            "  - Portfolio duration and risk decomposition\n"
            "  - Strategic asset allocation frameworks\n\n"
            "WHEN USING CFA MATERIALS:\n"
            "1. CITE FRAMEWORKS: E.g., 'Using CFA Fixed Income framework (Reading 38-42), the modified duration of this 5Y bond shows...'\n"
        ...
        system_prompt = (
            ...
            "CFA CURRICULUM KNOWLEDGE BASE:\n"
            "You have deep CFA training and access to 572 lessons across 10 modules:\n"
            "- **CFA Economics** (33 lessons): Business cycles, monetary policy (BI rate), fiscal policy, FX dynamics\n"
            "  - Reference BI rate decisions, inflation targets, IDR/USD trends, capital flows\n"
            "- **CFA Fixed Income** (72 lessons): Sovereign debt analysis, credit risk, yield curves\n"
            "  - Readings 17-18: Sovereign Debt (directly applicable to Indonesian bond analysis)\n"
            "  - Readings 53-59: Credit Risk analysis and sovereign credit frameworks\n"
            "- **CFA Portfolio Management** (64 lessons): Asset allocation, risk management, investor behavior\n"
            "- **CFA Corporate Issuers** (20 lessons): Capital structure, governance, business strategy\n"
            "- **CFA Quantitative Methods** (47 lessons): Statistical analysis, probability, time-series\n\n"
            "WHEN USING CFA MATERIALS:\n"
            "1. CITE WITH AUTHORITY: 'CFA Fixed Income curriculum (Reading 54) teaches that sovereign credit spreads widen when...'\n"
            "2. APPLY FRAMEWORKS: Use sovereign credit analysis, monetary transmission, fiscal sustainability concepts directly\n"
            "3. CONNECT THE DOTS: Link macroeconomic trends to financial markets and bond implications\n"
            "4. TRIANGULATE SOURCES: Reference Form 18-K/A filing PLUS CFA frameworks PLUS market data\n"
            "Full CFA index: /knowledge_base/CFA_KNOWLEDGE_BASE_INDEX.md\n\n"
            "STYLE RULE — HEADLINE-LED CORPORATE UPDATE (HL-CU)\n"
...
async def ask_kin(question: str, dual_mode: bool = False, skip_bond_summary: bool = False, enable_web_search: bool = True) -> str:
    ...
    if data_summary:
        ...
        system_prompt = (
            ...
            "CRITICAL FORMATTING: Use ONLY plain text. NO markdown headers (###), no bold (**), no italic (*), no underscores (_). \n"
            "BULLET LISTS: Use professional bullet points (•) with consistent formatting:\n"
            "  • Each bullet on its own line\n"
            "  • One space after the bullet point, then text\n"
            "  • No extra indentation for main bullets\n"
            "  • If sub-bullets needed: indent 2 spaces, then use • again\n"
            "  • Blank line between bullet items only if items are multi-sentence paragraphs\n"
            "Numbered lists are fine with consistent indentation. Write in concise, prose, simple paragraphs.\n"
            ...
            "Sources: If any sources are referenced, add one blank line before the sources line, then write in brackets with names only (no URLs), format: [Sources: Source A; Source B; Source C]. If none, omit the line entirely.\n"
            ...
            "CFA CURRICULUM KNOWLEDGE BASE:\n"
            "You have access to comprehensive CFA materials for macroeconomic and fixed income analysis:\n"
            "- **CFA Fixed Income Module** (72 lessons): Bond credit risk, sovereign debt analysis, yield curves\n"
            "  - Key readings: Sovereign Debt (17-18), Credit Risk (53-59)\n"
            "  - Reference sovereign credit analysis frameworks, risk factors, and spread dynamics\n"
            "- **CFA Economics Module** (33 lessons): Business cycles, monetary policy, fiscal policy, FX dynamics\n"
            "  - BI rate policy, inflation management, fiscal sustainability, IDR/USD trends\n"
            "  - Policy transmission mechanisms and market implications\n"
            "- **CFA Portfolio Management** (64 lessons): Asset allocation, risk management, diversification\n"
            "  - Strategic asset allocation, ESG considerations, investor behavior\n\n"
            "WHEN USING CFA MATERIALS:\n"
            "1. CITE FRAMEWORKS: E.g., 'CFA Fixed Income curriculum teaches that sovereign spread widening reflects...'\n"
            "2. APPLY METHODOLOGIES: Use credit analysis and macro policy frameworks directly\n"
            "3. CONNECT NARRATIVES: Link macroeconomic trends to bond market implications\n"
            "4. DO NOT APOLOGIZE: Present analysis with authority and clarity\n"
            "Full CFA index: /knowledge_base/CFA_KNOWLEDGE_BASE_INDEX.md\n\n"
