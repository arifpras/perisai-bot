...
async def examples_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    examples_text = (
        ...
        "<b>📊 Charts & Visualizations:</b>\n"
        "/kei plot yield 10 year 2025\n"
        "/kei chart 5 and 10 years 2024\n"
        "/kin show price 5 year 2023\n\n"
        ...
        "<b>💡 Tips:</b>\n"
        "• Use <b>plot/chart/show/graph/visualize</b> to get charts\n"
        ...
        "• Charts come as image + full analysis (no truncation)!"
    )
