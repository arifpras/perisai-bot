...
def summarize_intent_result(intent, rows_list: List[dict]) -> str:
    ...
    if len(rows_list) > 5 or is_range_query:
        ...
        # Use 3-char header names to match 3-char data columns
        ...
        for tenor, tenor_label in zip(tenors, tenor_labels):
            ...
            if metric_values:
                ...
                row_str = f"{tenor_label:<{tenor_width}} | {count:>{cnt_width}} | {min_val:>{min_width}.2f} | {max_val:>{max_width}.2f} | {avg_val:>{avg_width}.2f} | {std_val:>{std_width}.2f}"
...
async def ask_kei(question: str, dual_mode: bool = False) -> str:
    ...
    if is_data_query:
        system_prompt = (
            ...
            "EXCEPTION: For identity/persona questions (e.g., 'who are you', 'what is your role', 'tell me about yourself'), DO NOT use any headline, DO NOT use any emoji (including 📊), answer directly in 2-3 conversational sentences using first person, max 2 sentences per paragraph, personal and engaging. Start immediately with 'I'm Kei...' without any symbols or formatting.\n"
...
async def ask_kin(question: str, dual_mode: bool = False) -> str:
    ...
    if data_summary:
        ...
        system_prompt = (
            ...
            "EXCEPTION: For identity/persona questions (e.g., 'who are you', 'what is your role', 'tell me about yourself'), DO NOT use any headline, DO NOT use any emoji (including 🌍), answer directly in 2-3 conversational sentences using first person, max 2 sentences per paragraph, personal and engaging. Start immediately with 'I'm Kin...' without any symbols or formatting.\n"
