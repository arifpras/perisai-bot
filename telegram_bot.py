...
async def ask_kin(question: str, dual_mode: bool = False, skip_bond_summary: bool = False, enable_web_search: bool = True) -> str:
    ...
    if data_summary:
        ...
        system_prompt = (
            ...
            "CRITICAL FORMATTING: Use ONLY plain text. NO markdown headers (###), no bold (**), no italic (*), no underscores (_). For bullet lists, use professional bullet points (•) not dashes (-). Numbered lists are fine. Write in concise, prose, simple paragraphs.\n"
