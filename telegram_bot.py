...
async def ask_kei(question: str, dual_mode: bool = False) -> str:
    ...
    if is_data_query:
        ...
        system_prompt = (
            ...
            "1. **indonesia_sec_filings_complete.md** — Republic of Indonesia Form 18-K/A (July 25, 2025 + Oct 8, 2025 Amendment) with complete data as of Jan 2, 2026. Authoritative source for:\n"
            ...
            "• CITE THE SEC FILING: \"According to Indonesia's Form 18-K/A filing (July 2025)...\"\n"
            "• PROVIDE SPECIFIC DATA: Budget amounts (Rp Trillions), timelines, forecasts through 2029\n"
            "• EXPLAIN MECHANISMS: How policies work, implementation timelines, real-world constraints\n"
            "• QUANTIFY IMPACT: Infrastructure costs, revenue sources, expected economic effects\n"
            "• CONNECT TO MARKETS: Link to bond yields, FX rates, or investment returns where relevant\n\n"
            "EXAMPLE RESPONSES (REQUIRED FORMAT):\n"
            ...
            "Q: 'How much has Indonesia invested in renewable energy through JETP?'\n"
            "A: 'According to Form 18-K/A, Indonesia's Just Energy Transition Partnership (JETP) commitment is [$ amount]. Breakdown: [allocation by sector], [timeline], [environmental/climate targets]. This represents [% of energy budget / GDP context]...'\n\n"
            "STYLE RULE — HEADLINE-LED CORPORATE UPDATE (HL-CU)\n"
